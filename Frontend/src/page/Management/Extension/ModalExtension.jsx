...
const ModalExtension = ({ handleClose, lable, handleSubmit, data, resetTrigger, functionButton}) => {
                        ...
                        <div className="w-full ">
                            ...
                            <div className="flex items-center mb-4 px-3 w-full">
                                <div className="p-4 w-full">
                                    ...
                                    {loading ? (<div className="flex justify-center"><Loading /></div>) : hasSearched ? 
                                        (results.length === 0 ? (<div className="text-center text-gray-500 mt-4 italic">Không có kết quả phù hợp với tìm kiếm của bạn.</div>) 
                                    ...
                                    {(formData.icon || data?.icon) && (
                                        <div className="mt-2 text-gray-600 text-sm flex items-center gap-4">
                                            <span>Đã chọn: </span>
                                            <Icon icon={formData.icon || data.icon} width={28} height={28} />
                                        </div>
                                    )}
                                </div>
                            </div>                         
                                ...
                                <div className="flex items-center justify-center">
                                    {isLoading ? (
                                        ...
                                        <div>
                                            ...
                                            >
                                                <svg xmlns="http://www.w3.org/2000/svg" className="mr-2 inline w-6 fill-black" viewBox="0 0 32 32">
                                ...
                                {imageUrl.length > 0 ? (
                                    <div className="mt-4 grid grid-cols-4 gap-2 w-full p-2">
                                        {imageUrl.map((url, index) => (
                                            <div key={index} className="flex justify-center p-1 border border-gray-200 rounded-md">
                                                <img src={url} alt={`Uploaded ${index}`} className="h-[160px] w-[240px]"/>
                                            </div>
                                        ))}
                                    </div>
                                ) : (
